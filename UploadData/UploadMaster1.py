...
df = pd.read_csv("../CSV2/Master1.csv")
...
# convert df to json
df = df.to_json("../JSONdata/Master1.json" ,indent=4, orient="records")

# get data from json file
with open("../JSONdata/Master1.json", "r") as f:
    data = json.load(f)
...
for row in data:
    ...
    response = supabase.from_("master1").insert(row).execute()
    print(response)
