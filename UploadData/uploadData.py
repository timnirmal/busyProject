...
# open CSV2/Tran1.csv to dataframe
...
# convert df to json
df = df.to_json("../JSONdata/Tran1.json" ,indent=4, orient="records")

# get data from json file
with open("../JSONdata/Tran1.json", "r") as f:
    data = json.load(f)
...
for row in data:
    ...
    response = supabase.from_("tran1").insert(row).execute()
    print(response)
